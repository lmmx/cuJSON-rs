...
- The Python distribution is `cujson-rs` (crates/cujson-py/pyproject.toml), building `cujson_rs-<version>-cp310-abi3-*.whl` that installs the `cujson` module (tier 2, built and imported here)
